...
Ejemplo de ejecución:
    ...
    CALL dbMain.uspUpdateClient('Fabio Anaya', 'NATURAL', '1221233', 'sas Anaya', 'j-sas-@hotmail.com', '32sas1', '32as1241', 'Diagonalassas 32D #32 sur 39',5, 1)
----------------------------------------------------------------------------------------
...
DROP PROCEDURE IF EXISTS dbMain.uspUpdateClient;
DELIMITER &&
CREATE PROCEDURE dbMain.uspUpdateClient(
IN name VARCHAR(150),
